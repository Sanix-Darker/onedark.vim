...
let s:colors = {
      ...
      \ "cursor_grey": get(s:overrides, "cursor_grey", { "gui": "#282C34", "cterm": "236", "cterm16": "0" }),
      \ "visual_grey": get(s:overrides, "visual_grey", { "gui": "#282C34", "cterm": "237", "cterm16": "8" }),
      \ "menu_grey": get(s:overrides, "menu_grey", { "gui": "#3E4452", "cterm": "237", "cterm16": "7" }),
      \ "special_grey": get(s:overrides, "special_grey", { "gui": "#282C34", "cterm": "238", "cterm16": "7" }),
